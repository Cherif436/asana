...
export default function FirstSection() {
  ...
  return (
    <div className="flex flex-col items-center justify-center px-20 py-20 space-y-10 text-center m:px-0">
      {!submitted ? (
        <div className="text-5xl ">
          ...
          <Form {...form}>
            {!submitted ? (
              <form onSubmit={form.handleSubmit(onSubmit)} className="p-8 space-y-6 border md:w-2/3 rounded-xl ">
         ...
         control={form.control}
          ...
          />
             <div className="flex items-center justify-center gap-4">
              <Button type="submit" className="bg-[#000] text-xl rounded-sm w-80 h-20" disabled={loading} onClick={() => form.handleSubmit(onSubmit)}>
                Submit
              </Button>
            </div>
          </form>
