...
function SecondSection() {
  ...
  return (
    <div ref = {ref} className="flex flex-col items-center justify-center p-10 md:py-20">
      <div className="flex items-center justify-center">
        <div style={{
          ...
          <motion.div initial={{ y: 100, opacity: 0 }} animate={{ y: 0, opacity: 1 }} className="grid items-center justify-center grid-cols-2 py-10 md:flex md:space-x-10 ">
      ...
      <motion.div initial={{ y: 100, opacity: 0 }} animate={{ y: 0, opacity: 1 }} className="hidden py-20 pt-10 text-4xl md:text-6xl md:block">See how teams use Bird
      </motion.div>
      <div className="items-center justify-center hidden md:flex ">
        {tabs.map((tab) => (
          <div key={tab.name} className={`flex justify-center items-center space-x-10 w-60 ${activeTab === tab ? "border-b-4 pt-2 border-gray-500 text-gray-800" : "text-muted-foreground"}`}>
            <div className="flex items-center justify-center w-20 h-20 text-3xl text-center" onClick={() => setActiveTab(tab)} style={{cursor:'pointer'}}>
      ...
      <div className="hidden pt-10 md:block">
        {activeTab && (
          <div className="flex justify-center">
            <div style={{height : '525px', width : '700px'}} className="flex-col p-10 bg-gray-200 rounded-md">
            ...
            <div style={{height : '525px', width : '700px'}} className="flex items-center justify-center rounded-md bg-gradient-to-r from-gray-400 to-gray-100">
